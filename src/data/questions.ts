...
export const questions: Question[] = [
  ...
  },
  {
    ...
    correctOptionId: 1,
    funFact:
      `📔 法拉第晚年记忆力严重衰退，经常忘记自己做过什么实验。但他有一个绝招：坚持写日记！从21岁开始，直到76岁去世，法拉第写了超过40年的实验日记，超过3000页，记录了超过16000个实验的详细过程！就连今天中午吃了什么、明天要见什么人，也都记得清清楚楚。这些日记后来成了科学史上最珍贵的文献之一——堪称"最强辅助记忆法"！`,
    wrongRoast:
